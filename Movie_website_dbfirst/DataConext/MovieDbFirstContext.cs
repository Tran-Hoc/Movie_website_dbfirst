...
namespace Movie_website_dbfirst.DataConext;
...
public partial class MovieDbFirstContext : DbContext
{
    ...
    //        => optionsBuilder.UseSqlServer("Data Source=.\\Sqlexpress;Initial Catalog=Movie_DbFirst;Integrated Security=True; TrustServerCertificate=True; User ID=sa;Password=1234");

    //protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    //{
    //    if (!optionsBuilder.IsConfigured)
    //    {
    //        optionsBuilder.UseSqlServer("Name=ConnectionStrings:Movie_DbFirst");
    //    }
    //}
    ...
    public DbSet<Movie_website_dbfirst.Models.MovieVM> MovieVM { get; set; }
}
